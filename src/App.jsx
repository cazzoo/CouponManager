...
import { Container, Typography, Box, AppBar, Toolbar, Button, Tabs, Tab, IconButton } from '@mui/material';
...
function App({ isDarkMode, onThemeChange }) {
  ...
  const handleMarkAsUsed = (couponId) => {
    setCoupons(coupons.map(coupon => 
      coupon.id === couponId ? { ...coupon, currentValue: '0' } : coupon
    ));
  };
    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" sx={{ backgroundColor: '#2e7d32' }}>
        <Toolbar sx={{ borderBottom: 1, borderColor: 'divider' }}>
          ...
          <IconButton sx={{ ml: 1 }} onClick={() => onThemeChange(!isDarkMode)} color="inherit">
